...
<body>
	<div class="bloc_one">
		...
		<div class="Head-title">S'inscrire</div>
		<div class="logs">
			<form action="/index.php?action=signup" method="POST">
				...
				<label for="passwd_confirm">Retapez votre mot de passe</label>
				<input type="password" name="passwd_confirm" id="passwd_confirm" required/><br />
